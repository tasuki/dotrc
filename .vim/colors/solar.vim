...
call s:h("LineNr", s:base5, s:base1, "", "")
...
call s:h("DiffText", s:blue, s:bg_blue, "bold", s:blue)
...
call s:h("CursorLine", "", s:base1, "", "")
call s:h("ColorColumn", "", s:base1, "", "")
call s:h("Cursor", s:base0, s:base8, "", "")
hi! link lCursor Cursor
call s:h("MatchParen", s:base0, s:base4, "bold", "")
...
if has("nvim-0.10")
	...
	call s:h("@markup.heading", s:base4, "", "bold", "")
